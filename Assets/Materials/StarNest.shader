Shader "ShaderMan/StarNest "
{
	...
	SubShader
	{
    	...
    	Pass
    	{
            ...
            // Original code Star Nest by Pablo Roman Andrioli, under the MIT License.
        	...
        	fixed4 frag(VertexOutput i) : SV_Target
        	{
            	...
            	fixed3 from = fixed3(1.0,0.5,0.5);
                ...
                //v = float3(length(v),v,saturation); //color adjust
                return float4(mul(v, .01), 1.0);
            }
        	ENDCG
    	}
    }
